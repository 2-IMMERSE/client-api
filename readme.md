...
This includes:
* [General component documentation](doc/component.md)
* [App2app protocol documentation](doc/app2app-protocol.md)
* [Component parameters documentation](doc/component-params.md)
* [Intra-client communications, signalling, and data: strategies and suggestions](doc/comms-signalling-data.md)
...
The `test/run_local_servers.sh` script in the test directory can be used to conveniently run the local services below, see the [test page readme](test/readme.md).
...
See the [test page readme](test/readme.md) for installation, setup, and usage information.
